...
import 'package:tangullo/ui/views/new_homepage/screens/patient_dashboard/BodyMesurment/body_m_shared_preferences.dart';
import 'package:tangullo/ui/views/new_homepage/screens/patient_dashboard/BodyMesurment/input.dart';
import 'package:tangullo/ui/views/new_homepage/screens/patient_dashboard/BodyMesurment/models.dart';
import 'package:tangullo/ui/views/new_homepage/screens/patient_dashboard/fitness_app_home_screen.dart';
import 'package:tangullo/ui/views/new_homepage/services/database.dart';

// Remove the global late variable
// late User user;
...
class _ResultState extends State<Result> {
  // Add user variable as class property
  late User user;
  ...
  void initState() {
    ...
    // Initialize other variables that don't need setState
  ...
  Widget build(BuildContext context) {
    // Remove the setState and user initialization from build
    return Scaffold(
      appBar: AppBar(
      ...
      body: ListView(
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              _saveDetails();
              DatabaseService(uid: user.uid).updateBodyMeasurementData(
                  int.parse(_height),
                  int.parse(_weight),
                  double.parse(_bMR),
                  double.parse(_bMW),
