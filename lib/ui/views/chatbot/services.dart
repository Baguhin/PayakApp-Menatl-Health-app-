...
class GeminiApi {
  ...
  static Future<(String, http.Response)> geminiChatApi(
    ...
    try {
      var url = Uri.parse(
          'https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyBoujHskCig-WmNriIsiIXcoAnNPOZYzmo');
  ...
  static getResponse(String question) {}
}
